...
//{
    ...
    typedef enum 
    {
        ...
        PlayFabErrorMatchmakingCreateRequestUserListMissing = 2006,
        PlayFabErrorMatchmakingCreateRequestGiveUpAfterInvalid = 2007,
        ...
        PlayFabErrorMatchmakingGetTicketUserMismatch = 2021,
        PlayFabErrorMatchmakingJoinTicketServerIdentityInvalid = 2022,
        PlayFabErrorMatchmakingJoinTicketUserIdentityMismatch = 2023,
