...
@implementation PlayFabEntityAPI
...
-(void) UpdateRole:(UpdateGroupRoleRequest*)request success:(UpdateRoleCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Group/UpdateRole"] body:jsonString authType:nil authKey:nil];
}
